...
from CLIPFinetune.train_model_CC import main
...
parser.add_argument(
    "--output_dir",
    default="/root/sdusht/data/3_2021-NeurIPS-NCR-main/new_output_model_CLIP/finetune_withGMM_adapter/CC/CLIP0.8",
    help="Output dir."
)
parser.add_argument(
    "--margin_image",
