...
from CLIPFinetune.train_model_addGMM_tripletloss_dynamic_margin_CC import main
...
parser.add_argument(
    "--data_name",
    default="CC",
    help="Name of the dataset{flickr, COCO, CC}.",
)
parser.add_argument(
    "--noisy_file",
    default=None,
...
parser.add_argument(
    "--output_dir",
    default="/root/sdusht/data/3_2021-NeurIPS-NCR-main/new_output_model_CLIP/finetune_withGMM_adapter/CC/new",
    help="Output dir."
)
parser.add_argument(
    "--margin_image",
