...
parser.add_argument(
    "--noisy_file",
    default="/root/sdusht/dataset/NCR-data/noise_index_DECL/noise_file/coco/noise_inx_0.6.npy",
...
parser.add_argument(
    "--output_dir",
    default="/root/sdusht/data/3_2021-NeurIPS-NCR-main/new_output_model_CLIP/finetune_withGMM_adapter/COCO/0.6/tripletloss_dynamic_margin",
    help="Output dir."
)
parser.add_argument(
    "--margin_image",
