...
checkpoint = torch.load(checkpoint_path, map_location=lambda storage, loc: storage.cuda(3))
...
r, rt = i2t(5000, similarity, per_captions=5, return_ranks=True)
ri, rti = t2i(5000, similarity, per_captions=5, return_ranks=True)
