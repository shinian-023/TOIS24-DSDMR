...
def run():
    ...
    parser.add_argument(
        "--data_path", default="/root/sdusht/dataset/NCR-data/data", help="path to datasets"
    )
    parser.add_argument(
        "--data_name", default="f30k_precomp", help="{coco,f30k,cc152k}_precomp"
    )
    parser.add_argument(
        "--vocab_path", default="/root/sdusht/dataset/NCR-data/vocab", help="Path to saved vocabulary json files.",
    )
    ...
    # 从下面挪上来了，要不然因为是多卡，不指定会报显卡错误
    os.environ["CUDA_VISIBLE_DEVICES"] = "1"
    # 修改
    Resume = True
    if Resume:
        path_checkpoint = '/root/sdusht/data/3_2021-NeurIPS-NCR-main/output/2022_12_07_20_27_53/checkpoint_13.pth.tar'
        # path_checkpoint = '/root/sdusht/data/3_2021-NeurIPS-NCR-main/output/2022_12_07_19_21_03/checkpoint_5.pth.tar'
...
if __name__ == "__main__":
    ...
    print("modol loaded,continue to training")
    '''
    run()
